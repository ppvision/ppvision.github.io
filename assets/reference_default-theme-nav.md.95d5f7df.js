import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.ffb2c379.js";const u=JSON.parse('{"title":"Nav","description":"","frontmatter":{},"headers":[],"relativePath":"reference/default-theme-nav.md","filePath":"reference/default-theme-nav.md","lastUpdated":1678520727000}'),p={name:"reference/default-theme-nav.md"},e=l(`<h1 id="nav" tabindex="-1">Nav <a class="header-anchor" href="#nav" aria-label="Permalink to &quot;Nav&quot;">​</a></h1><p>The Nav is the navigation bar displayed on top of the page. It contains the site title, global menu links, etc.</p><h2 id="site-title-and-logo" tabindex="-1">Site Title and Logo <a class="header-anchor" href="#site-title-and-logo" aria-label="Permalink to &quot;Site Title and Logo&quot;">​</a></h2><p>By default, nav shows the title of the site referencing <a href="./site-config#title"><code>config.title</code></a> value. If you would like to change what&#39;s displayed on nav, you may define custom text in <code>themeConfig.siteTitle</code> option.</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">export</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">default</span><span style="color:#E1E4E8;"> {</span></span>
