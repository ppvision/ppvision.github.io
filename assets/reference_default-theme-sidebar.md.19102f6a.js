import{_ as p,C as e,o,c as t,k as s,a as n,H as c,Q as a}from"./chunks/framework.ffb2c379.js";const x=JSON.parse('{"title":"Sidebar","description":"","frontmatter":{},"headers":[],"relativePath":"reference/default-theme-sidebar.md","filePath":"reference/default-theme-sidebar.md","lastUpdated":1688360524000}'),r={name:"reference/default-theme-sidebar.md"},E=a(`<h1 id="sidebar" tabindex="-1">Sidebar <a class="header-anchor" href="#sidebar" aria-label="Permalink to &quot;Sidebar&quot;">​</a></h1><p>The sidebar is the main navigation block for your documentation. You can configure the sidebar menu in <a href="./default-theme-config#sidebar"><code>themeConfig.sidebar</code></a>.</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">export</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">default</span><span style="color:#E1E4E8;"> {</span></span>
